...
ВАЖНО про живую речь (прораб говорит на бегу):
- Игнорируй слова-паразиты, оговорки, паузы и не относящееся к делу: «эээ», «ну это», «короче», «так, погоди», «блин», «что там ещё», «в общем», «как его».
- Если прораб поправился — бери ПОСЛЕДНЮЮ формулировку. «десять… нет, двадцать форсунок» → 20 форсунок. «дождеватели, а нет, сопла» → сопла.
- Не превращай в позиции размышления и лишний текст. Позиция — только то, что реально нужно в смету.
- Дубли одной позиции объединяй по смыслу, не создавай пустых/бессмысленных названий.
Примеры:
...
"так, эээ, погоди… короче нам надо это, десять… нет, пятнадцать дождевателей, ну и что там ещё, метров сто трубы пнд" →
{"object":null,"client":null,"items":[{"name":"дождеватель","qty":15,"unit":"шт","price":null},{"name":"труба пнд","qty":100,"unit":"м","price":null}]}`;
