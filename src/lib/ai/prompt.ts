...
1) заказчика — кому предназначена смета, если это названо в речи («смета для ИП Адилет», «заказчик ООО Ромашка», «клиент Иван Петрович», «для Ахмеда»). Верни как произнесено, сохраняя форму («ИП …», «ООО …»). Заказчика НЕ добавляй в список позиций. Если не назван — null.
